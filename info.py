...
# FORCE_SUB 
auth_req_channels = "-1002997352630"  # request to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
TMDB_ON_SEARCH = False   # Use TMDB Poster On Search Results
...
APP_NAME = None
ON_HEROKU = False
BIND_ADRESS = 'moviedownloaderbot.koyeb.app'
FQDN = BIND_ADRESS
